...
#define LED1_OFF()	(LD1_GPIO_Port->BSRR=(LD1_Pin)<<16)
#define LED1_TOGGLE()	(LD1_GPIO_Port->ODR ^=(LD1_Pin))
#define LED1_FLASH()	do{LED1_TOGGLE();LED1_TOGGLE();}while(0)

#define LED2_ON()	(LD2_GPIO_Port->BSRR=(LD2_Pin))
#define LED2_OFF()	(LD2_GPIO_Port->BSRR=(LD2_Pin)<<16)
#define LED2_TOGGLE()	(LD2_GPIO_Port->ODR ^=(LD2_Pin))
#define LED2_FLASH()	do{LED2_TOGGLE();LED2_TOGGLE();}while(0)

#define LED3_ON()	(LD3_GPIO_Port->BSRR=(LD3_Pin))
#define LED3_OFF()	(LD3_GPIO_Port->BSRR=(LD3_Pin)<<16)
#define LED3_TOGGLE()	(LD3_GPIO_Port->ODR ^=(LD3_Pin))
